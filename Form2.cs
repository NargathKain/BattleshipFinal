...
namespace Battleship2
{
    public partial class Form2 : Form
    {
        ...
        {
            paixnidi.PlayerFire(AIGridPicBox, shotRowTextBox.Text, shotColTextBox.Text, this.FindForm(), secondsElapsed);
            ...
            paixnidi.AIFire(playerGridPicBox, this.FindForm(),secondsElapsed);
        }
